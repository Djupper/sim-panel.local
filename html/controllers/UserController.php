                ...
                'rules' => [
                    [
                        ...
                        'matchCallback' => function ($rule, $action, $sd) {
                            $this->getGroupeRole();
                            return  (UserIdentity::find()->where('(auth_key_first !="" AND auth_key_first IS NOT NULL AND auth_key_first != "0") AND id ='.$this->oUser->id)->exists());
